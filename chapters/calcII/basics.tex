...
There are several techniques for finding anti-derivatives, including integration by substitution, integration by parts, and using integration tables. It's important to note that for most functions, there is no closed-form solution for the antiderivative, in those cases numerical integration is used.

Here are some examples of finding anti-derivatives:

1. The anti-derivative of $x^2$ is $\frac{x^3}{3} + C$ , where C is an arbitrary constant.\\
